...
test("Register a new User with missing name", () =>
  __awaiter(void 0, void 0, void 0, function* () {
...
test("Register a new User with missing email_id", () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const res = yield (0, supertest_1.default)(app_1.default)
      .post("/register")
      .send({
...
test("Register a new User with missing password", () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const res = yield (0, supertest_1.default)(app_1.default)
      .post("/register")
      .send({
...
test("Register a new User with invalid email domain", () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const res = yield (0, supertest_1.default)(app_1.default)
      .post("/register")
      .send({
      ...
      .expect(400);
    expect(res.body.error).toBe(
      "Bad Request: Only VIT institutional email ID's allowed."
    );
  }));
...
test("Re-registering already existing User", () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const res = yield (0, supertest_1.default)(app_1.default)
      .post("/register")
      .send({
...
test("Server error response", () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield (0, supertest_1.default)(app_1.default)
      ...
      .send({
        name: "Test2",
        email_id: "Test2@vitbhopal.ac.in",
        password: "Test2@vitbhopal.ac.in",
      })
      .expect(500);
...
test("Register a new User with invalid email format", () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const res = yield (0, supertest_1.default)(app_1.default)
      .post("/register")
      .send({
        name: "Test",
        email_id: "Testvitbhopal.ac.in",
        password: "SomeRandomPassword",
      })
      .expect(400);
    expect(res.body.error).toBe(
