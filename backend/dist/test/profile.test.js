...
test("Access profile data without being authenticated", () =>
  __awaiter(void 0, void 0, void 0, function* () {
...
test("Access profile data successfully", () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const res = yield (0, supertest_1.default)(app_1.default)
      ...
      .expect(200);
    expect(res.body.email_id).toBe("Test@vitbhopal.ac.in");
  }));
test("Access profile data with an invalid token", () =>
  __awaiter(void 0, void 0, void 0, function* () {
