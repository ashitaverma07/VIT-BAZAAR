  ...
  return (
    <div className="bg-gray-900 items-center h-full w-full bg-footerbgcolor md:flex-row flex   justify-evenly flex-col-reverse">
      <FooterSection extraClass="mt-12 hidden md:block">
        <FooterItem name="Home" link="/home" />
        <FooterItem name="Bazaar Aid" link="/Aboutus" />
        <FooterItem name="Post Item" link="/form" />
      </FooterSection>
      <ToastContainer />
      ...
      <FooterSection extraClass="flex md:flex-col justify-between before:invisible">
        ...
        <p className="text-white text-l mb-0"></p>
      ...
      <FooterSection extraClass="mt-12 hidden md:block">
        <FooterItem name="Admin" link="/adminPanel" />
        <FooterItem name="Events" link="/Testimonials" />
